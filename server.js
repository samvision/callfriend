...
var socketIoServer = 'admin-pc' + ':' + serverPort;

var httpOptions =  {
 key: fs.readFileSync(__dirname + '/keys/admin-pc-private.pem'), 
 cert: fs.readFileSync(__dirname + '/keys/admin-pc-public-cert.pem')
}
